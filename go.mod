...
require (
	...
	github.com/treasurenetprotocol/treasurenet v1.0.0-beta
...
// replace github.com/treasurenetprotocol/treasurenet v1.0.1-beta => github.com/treasurenetprotocol/treasurenet v1.0.0-beta
